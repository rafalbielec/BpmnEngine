...
public sealed class PolishConstants
{
    ...
    public const string NumberOfPeopleLabel = "Liczba osób";
    public const string RoomLabel = "Wypisz salę";
    public const string BusinessKeyLabel = "Klucz biznesowy procesu";
