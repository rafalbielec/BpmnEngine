...
public class BouDirectorChecksHandler : IExternalTaskHandler
{
    private readonly ILogger<BouDirectorChecksHandler> _logger;

    public BouDirectorChecksHandler(ILogger<BouDirectorChecksHandler> logger)
    {
        _logger = logger;
    }
